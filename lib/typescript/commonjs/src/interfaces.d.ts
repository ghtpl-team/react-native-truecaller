 ...
 */
export type TruecallerButtonTextKey = keyof typeof TRUECALLER_ANDROID_CUSTOMIZATIONS.BUTTON_TEXTS;
export type TruecallerButtonTextValue = (typeof TRUECALLER_ANDROID_CUSTOMIZATIONS.BUTTON_TEXTS)[TruecallerButtonTextKey];
/**
 * Type for Button Shape Customizations
 */
export type TruecallerButtonShapeKey = keyof typeof TRUECALLER_ANDROID_CUSTOMIZATIONS.BUTTON_SHAPES;
export type TruecallerButtonShapeValue = (typeof TRUECALLER_ANDROID_CUSTOMIZATIONS.BUTTON_SHAPES)[TruecallerButtonShapeKey];
/**
 * Type for Footer Button Text Customizations
 */
export type TruecallerFooterButtonTextKey = keyof typeof TRUECALLER_ANDROID_CUSTOMIZATIONS.FOOTER_TEXTS;
export type TruecallerFooterButtonTextValue = (typeof TRUECALLER_ANDROID_CUSTOMIZATIONS.FOOTER_TEXTS)[TruecallerFooterButtonTextKey];
/**
