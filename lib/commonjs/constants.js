...
exports.TRUECALLER_LANGUAGES = exports.TRUECALLER_IOS_EVENTS = exports.TRUECALLER_API_URLS = exports.TRUECALLER_ANDROID_EVENTS = exports.TRUECALLER_ANDROID_CUSTOMIZATIONS = exports.DEFAULT_LANGUAGE = exports.DEFAULT_FOOTER_BUTTON_TEXT = exports.DEFAULT_CONSENT_HEADING = exports.DEFAULT_BUTTON_TEXT_COLOR = exports.DEFAULT_BUTTON_TEXT = exports.DEFAULT_BUTTON_SHAPE = exports.DEFAULT_BUTTON_COLOR = void 0;
// Android Event Constants
const TRUECALLER_ANDROID_EVENTS = exports.TRUECALLER_ANDROID_EVENTS = {
  SUCCESS: 'TruecallerAndroidSuccess',
  FAILURE: 'TruecallerAndroidFailure'
};

// iOS Event Constants
const TRUECALLER_IOS_EVENTS = exports.TRUECALLER_IOS_EVENTS = {
  SUCCESS: 'TruecallerIOSSuccess',
  FAILURE: 'TruecallerIOSFailure'
};

// Button Text Customizations for Android
const TRUECALLER_ANDROID_CUSTOMIZATIONS = exports.TRUECALLER_ANDROID_CUSTOMIZATIONS = {
  BUTTON_TEXTS: {
...
const TRUECALLER_API_URLS = exports.TRUECALLER_API_URLS = {
...
const TRUECALLER_LANGUAGES = exports.TRUECALLER_LANGUAGES = {
  ENGLISH: 'en',
  HINDI: 'hi',
  MARATHI: 'mr',
  TELUGU: 'te',
...
const DEFAULT_BUTTON_TEXT_COLOR = exports.DEFAULT_BUTTON_TEXT_COLOR = '#FFFFFF';
const DEFAULT_BUTTON_COLOR = exports.DEFAULT_BUTTON_COLOR = '#2C765CFF';
const DEFAULT_BUTTON_TEXT = exports.DEFAULT_BUTTON_TEXT = TRUECALLER_ANDROID_CUSTOMIZATIONS.BUTTON_TEXTS.ACCEPT;
const DEFAULT_BUTTON_SHAPE = exports.DEFAULT_BUTTON_SHAPE = TRUECALLER_ANDROID_CUSTOMIZATIONS.BUTTON_SHAPES.ROUNDED;
const DEFAULT_FOOTER_BUTTON_TEXT = exports.DEFAULT_FOOTER_BUTTON_TEXT = TRUECALLER_ANDROID_CUSTOMIZATIONS.FOOTER_TEXTS.ANOTHER_METHOD;
const DEFAULT_CONSENT_HEADING = exports.DEFAULT_CONSENT_HEADING = TRUECALLER_ANDROID_CUSTOMIZATIONS.CONSENT_HEADINGS.SIGN_UP_WITH;
const DEFAULT_LANGUAGE = exports.DEFAULT_LANGUAGE = TRUECALLER_LANGUAGES.ENGLISH;
